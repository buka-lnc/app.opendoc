...
export class Migration20240806060714 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql('create table `compiler_option` (`id` bigint unsigned not null auto_increment primary key comment \'主键\', `created_at` datetime not null default CURRENT_TIMESTAMP comment \'创建时间\', `updated_at` datetime not null default CURRENT_TIMESTAMP comment \'更新时间\', `key` varchar(63) not null comment \'选项键\', `label` varchar(63) not null comment \'选项名\', `description` varchar(255) not null default \'\' comment \'选项描述\', `format` varchar(31) not null comment \'选项格式\', `value` varchar(255) null comment \'选项值\', `compiler_id` bigint unsigned not null comment \'Compiler\') default character set utf8mb4 engine = InnoDB;')
